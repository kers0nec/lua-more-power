-- ============================================================
--  LuaMore · Gold Bar — wide in-game loading bar
--  Run as a LocalScript. Set LOADER_URL to the loader from
--  your LuaMore dashboard. A bottom-right pill with a gold
--  accent rail down the left edge — the classic "premium
--  script" look for paid-feel loaders.
--
...
local LOADING_POSITION = "bottom-right" -- "top" | "bottom-center" | "bottom-right" | "bottom-left"
local LOADING_BAR_BG = Color3.fromRGB(14, 11, 6)
local LOADING_ACCENT = Color3.fromRGB(246, 196, 83)
local LOADING_TEXT = Color3.fromRGB(255, 248, 232)
local LOADING_SUBTEXT = Color3.fromRGB(185, 160, 110)
local LOADING_DIM = false
local LOADING_SCREEN_BG = Color3.fromRGB(14, 11, 6)
local STROKE_COLOR = Color3.fromRGB(246, 196, 83)
local STROKE_ALPHA = 0.5
local SHOW_STROKE = true
local TRACK_COLOR = Color3.fromRGB(45, 35, 15)
-- -----------------------------------------------------------
...
-- Gold decoration: a vertical gold rail down the left edge.
local function decorate(bar)
	local rail = Instance.new("Frame")
	rail.Name = "GoldRail"
	rail.BackgroundColor3 = Color3.fromRGB(246, 196, 83)
