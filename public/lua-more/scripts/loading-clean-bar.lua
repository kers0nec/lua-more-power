-- ============================================================
--  LuaMore · Clean Bar — wide in-game loading bar
--  Run as a LocalScript. Set LOADER_URL to the loader from
--  your LuaMore dashboard. A minimal light bar with no stroke
--  and no glow — just a thin progress line under a quiet
--  top strip. Best for bright or busy game maps.
--
...
local LOADING_POSITION = "top" -- "top" | "bottom-center" | "bottom-right" | "bottom-left"
local LOADING_BAR_BG = Color3.fromRGB(13, 20, 36)
local LOADING_ACCENT = Color3.fromRGB(235, 240, 250)
local LOADING_TEXT = Color3.fromRGB(240, 245, 255)
local LOADING_SUBTEXT = Color3.fromRGB(150, 165, 195)
local LOADING_DIM = false
local LOADING_SCREEN_BG = Color3.fromRGB(13, 20, 36)
local STROKE_COLOR = Color3.fromRGB(13, 20, 36)
local STROKE_ALPHA = 1 -- fully transparent: the clean bar has no stroke
local SHOW_STROKE = false
local TRACK_COLOR = Color3.fromRGB(35, 42, 58)
-- -----------------------------------------------------------
