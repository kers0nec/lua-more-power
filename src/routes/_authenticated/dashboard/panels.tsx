    ...
    <div className="p-8 max-w-6xl">
        ...
        <div className="flex items-center gap-2">
          {isOwner && (
            <button
              ...
              className="btn-outline text-xs px-3.5 py-2 shrink-0 self-start md:self-auto flex items-center gap-2 border-primary/50 hover:border-primary/40"
            >
      ...
      {isOwner && (
        <div
          ...
          style={{ borderColor: "var(--primary)", background: "var(--accent)" }}
        >
          ...
          <div key={p.id} className="card-blue p-5">
            ...
            <div className="mt-4 rounded-lg bg-[#313338] p-4 text-white font-sans border border-[#3f4147]">
              ...
              <div className="flex items-center gap-2.5 mb-2.5">
                <div className="h-8 w-8 rounded-full shrink-0 flex items-center justify-center bg-primary/20 border border-primary/40">
                  <span className="font-bold text-primary text-xs">LM</span>
                </div>
