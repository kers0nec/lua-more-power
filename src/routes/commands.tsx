...
const STEPS: [string, string][] = [
  ...
  [
    "5",
    "Use /whitelist user duration — duration like 20s, 35m, 2h, 1d, 7d, 30d (omit for forever).",
  ],
...
const COMMANDS: [string, string][] = [
  ...
  [
    ...
    "Whitelist a user — 20s, 35m, 2h, 1d, 7d, 30d, or omit for forever",
  ],
            ...
            >
              {STEPS.map(([n, text]) => (
                ...
                >
                  ...
                  <span className="min-w-0 text-sm" style={{ color: "var(--foreground)" }}>
                    {text}
                  </span>
                </li>
              ))}
          ...
          <section>
            ...
            >
              {COMMANDS.map(([cmd, desc]) => (
                <div
                  key={cmd}
                  className="grid gap-2 p-4 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] md:items-center md:gap-6"
                  style={{ background: "var(--card)" }}
                >
                  <code
