              ...
              <div className="space-y-2.5">
                {rel.changes.map((c, i) => (
                  <div key={i} className="flex items-start gap-3 text-sm">
                    {c.type === "security" && (
                      <span className="mt-0.5 inline-flex shrink-0 items-center gap-1 rounded bg-primary/20 px-2 py-0.5 text-[10px] font-semibold uppercase text-primary border border-primary/40">
