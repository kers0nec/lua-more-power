...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Add a Lua script, choose access, and copy a hosted loader with LuaMore.",
      },
      { property: "og:title", content: "LuaMore — Control who runs your scripts" },
      {
        property: "og:description",
        content: "Scripts, license keys, Discord panels, and hosted loaders in one workspace.",
      },
      ...
      <main>
          ...
          <div className="site-section relative grid gap-14 py-20 lg:grid-cols-[0.88fr_1.12fr] lg:items-center lg:py-28">
            <div className="rise max-w-xl">
              ...
              <p className="mt-6 max-w-lg text-lg leading-8 text-muted-foreground">
                Add a script, choose how access works, then copy the loader. Scripts, keys, Discord,
                and delivery stay together.
              </p>
            ...
            <div className="landing-instrument rise" style={{ animationDelay: "100ms" }}>
              <div className="instrument-topbar">
                <span className="flex items-center gap-2">
                  <span className="status-dot" /> loader.lua
                </span>
                <span>live</span>
              </div>
              <div className="grid md:grid-cols-[1.2fr_0.8fr]">
                <div className="instrument-code">
                  ...
                  <div className="code-line">
                    <span>3</span>
                    <code>&nbsp; &quot;https://luamore.app/api/public/r/LM...&quot;</code>
                  </div>
                  <div className="code-line">
                    <span>4</span>
                    <code>))()</code>
              ...
              <div className="instrument-footer">
                <span>Nightfall Hub</span>
                <span>HWID enabled</span>
                <span>Release 12</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="mt-10 grid gap-px overflow-hidden border border-border bg-border sm:grid-cols-2 lg:grid-cols-4">
              {steps.map(([n, title, body]) => (
                <article key={n} className="bg-card p-6">
                  ...
                  <h3 className="mt-12 font-display text-xl">{title}</h3>
        ...
        <section className="site-section py-20 md:py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 font-display text-4xl sm:text-5xl">Every feature. Zero dollars.</h2>
            <p className="mt-4 text-muted-foreground">
              Unlimited scripts, keys, hosted loaders, Discord panels, and protection tools for
              every account.
            </p>
          </div>
          <div className="mx-auto mt-10 max-w-3xl overflow-hidden border border-primary bg-card">
            <div className="grid md:grid-cols-[0.7fr_1.3fr]">
              <div className="border-b border-border p-8 md:border-b-0 md:border-r">
                <span className="badge-blue">Free forever</span>
                <div className="mt-6 font-display text-6xl">$0</div>
                <p className="mt-2 text-sm text-muted-foreground">
                  No card. No billing. No upgrade.
                </p>
              </div>
              <div className="grid gap-3 p-8 sm:grid-cols-2">
                {[
                  ...
                  <span key={x} className="flex items-center gap-2 text-sm">
                    <Check size={14} className="text-primary" />
                    {x}
                  </span>
                ))}
            ...
            <Link to="/register" className="btn-primary m-4 mt-0 flex">
              Get started
            </Link>
          </div>
        </section>
        ...
        <section className="border-t border-border">
          <div className="site-section py-20 text-center">
            <h2 className="font-display text-4xl">Start with one project.</h2>
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Create your workspace, add your source, and copy the generated loader.
            </p>
