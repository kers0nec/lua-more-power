...
export function TosPage() {
  return (
    <PageShell eyebrow="Legal" title="Terms of Service" subtitle="Last updated: August 29, 2026">
      <article
        className="prose-lm space-y-6 text-sm leading-relaxed"
      ...
      >
        ...
        <p>
          ...
          license key management, obfuscation, loader authentication, Discord access panels, and
          usage analytics. The service is free. We may add, change, limit, or remove features at any
          time.
        </p>
        ...
        <p>
          ...
          revocation) but does not guarantee prevention of all cheating, leaking, or circumvention.
        </p>
        ...
        <p>
          LuaMore is provided free of charge. There are no paid subscriptions, no Stripe charges,
          and no ad-network checkpoints operated by LuaMore.
        </p>
        <h2 className="font-display text-2xl text-[color:var(--foreground)]">
        ...
        <p>
          ...
          Your use of those services is also subject to their terms and policies. We are not
          responsible for third-party outages, policy changes, or data handling outside our control.
        </p>
        ...
        <p>
          ...
          licensors&apos;. These Terms do not grant you any rights to our trademarks except as
