    ...
    <PageShell eyebrow="Legal" title="Privacy Policy" subtitle="Last updated: August 29, 2026">
      ...
      >
        ...
        <p>
          ...
          We record when you accept these Terms and our Privacy Policy. Email is used for account
          recovery and key delivery notices.
        </p>
        <p>
        ...
        <p>
          ...
          We store projects, scripts, obfuscated outputs, license keys, key metadata, HWID hashes
          you bind to keys, and settings you configure.
        </p>
        <p>
          ...
          deliver scripts, including hashed hardware identifiers where configured, executor name,
          session nonces, and delivery telemetry.
        </p>
        ...
        <p>
          ...
          recovery, and control what your projects collect from end users. Contact us through
          Discord to submit an access or deletion request.
        </p>
        ...
        <p>
          If you access the service from other regions, your information may be processed in the
