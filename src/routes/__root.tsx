...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lua Security — Luau Script Hosting & Protection" },
      { name: "description", content: "Lua Security is an advanced Lua script hosting and protection platform." },
      { name: "author", content: "Lua Security" },
      { property: "og:title", content: "Lua Security — Luau Script Hosting & Protection" },
      { property: "og:description", content: "Lua Security is an advanced Lua script hosting and protection platform." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Lua Security — Luau Script Hosting & Protection" },
      { name: "twitter:description", content: "Lua Security is an advanced Lua script hosting and protection platform." },
