  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went wrong while loading this view. You can try refreshing or head back home.
        </p>
        {error?.message && (
          <p className="mt-3 text-xs font-mono text-rose-400 bg-rose-950/40 border border-rose-800/40 rounded-lg p-2.5 break-words text-left">
            {error.message}
          </p>
        )}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://luamore.app/favicon.png" },
