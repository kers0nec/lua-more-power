...
export function SiteFooter() {
  return (
    <footer className="border-t border-border/60 bg-card/20">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-8 text-xs font-mono text-muted-foreground">
        ...
        <nav className="flex items-center gap-4">
          ...
          <Link to="/obfuscators" className="hover:text-primary transition-colors">
            Obfuscator
          </Link>
