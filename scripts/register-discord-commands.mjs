...
const DISCORD_COMMANDS = [
  {
    ...
    options: [
      ...
      { type: OPT.STRING, name: "code", description: "Lua source code", required: true },
      {
        type: OPT.BOOLEAN,
        name: "ffa",
        description: "Allow access without a key",
        required: false,
      },
      {
        type: OPT.BOOLEAN,
        name: "obfuscate",
        description: "Protect the source before hosting",
        required: false,
      },
      {
        type: OPT.STRING,
  ...
  },
  {
    ...
    options: [
      { type: OPT.STRING, name: "panel_id", description: "Panel ID", required: true },
      {
        type: OPT.INTEGER,
        name: "hours",
        description: "Hours valid (0 = permanent)",
        required: false,
        min_value: 0,
      },
    ...
    options: [
      {
        type: OPT.STRING,
        name: "script_id",
        description: "Script ID or public ID",
        required: true,
      },
